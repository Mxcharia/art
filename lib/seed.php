...
class Seed extends Mysql
{
  ...
  {
    $exhibitData = array(
      array('gallery_id' => array('val' => 1, 'type' => 'i'), 'name' => array('val' => 'Cityscapes Collection', 'type' => 's'), 'description' => array('val' => 'A collection of cityscape artworks.', 'type' => 's'), 'price' => array('val' => 1000, 'type' => 'i')),
      array('gallery_id' => array('val' => 2, 'type' => 'i'), 'name' => array('val' => 'Nature\'s Beauty', 'type' => 's'), 'description' => array('val' => 'An exhibit celebrating the beauty of nature.', 'type' => 's'), 'price' => array('val' => 1200, 'type' => 'i')),
      array('gallery_id' => array('val' => 3, 'type' => 'i'), 'name' => array('val' => 'Abstract Expressions', 'type' => 's'), 'description' => array('val' => 'An exhibit featuring abstract artworks.', 'type' => 's'), 'price' => array('val' => 800, 'type' => 'i')),
      array('gallery_id' => array('val' => 4, 'type' => 'i'), 'name' => array('val' => 'Vintage Vibes', 'type' => 's'), 'description' => array('val' => 'A collection of vintage and retro art pieces.', 'type' => 's'), 'price' => array('val' => 950, 'type' => 'i')),
      array('gallery_id' => array('val' => 5, 'type' => 'i'), 'name' => array('val' => 'Dreamscapes', 'type' => 's'), 'description' => array('val' => 'An exhibit showcasing dreamy and surreal artworks.', 'type' => 's'), 'price' => array('val' => 1100, 'type' => 'i')),
    );
